...
class DisplayState extends State<TeacherDisplay> {
  bool isLiked = false;
  int likeCount = 0;
  ...
  void _addComment(String comment, int postIndex) {
    setState(() {
      TeacherPostRepository.addComment(postIndex, {
        'name': 'zhy',
          ...
          builder: (BuildContext context, StateSetter setState) {
            List<Map<String, dynamic>> comments =
                List<Map<String, dynamic>>.from(
                    TeacherPostRepository.getPosts()[postIndex]['comments']);
            return Padding(
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> posts = TeacherPostRepository.getPosts();
