...
import '../Teacherpkgame/fenzupk/pk_results_page.dart';
import '../Teacherpkgame/pk_results_page.dart';
import '../chat/teacherchat/teacher_chat.dart';
                    ...
                    children: [
                          ...
                          onTap: () async {
                            ...
                            if (A) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => TeacherChatApp(),
                                  settings: RouteSettings(
                                      arguments: {'disableBack': true}),
                                ),
                              );
                      ...
                      Flexible(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            if (A) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => FenzuPKResultsPage(),
                                  settings: RouteSettings(
                                      arguments: {'disableBack': true}),
                                ),
                              );
                          ...
                          child: buildColumnItem(
                              'assets/images/myhome/4.png', '学生pk数据'),
                        ),
                      ),
                    ],
                  ),
