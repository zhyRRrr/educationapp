...
import '../../widget/loadrefreshlist/my_refresh_load_sliverlist.dart';
...
class _VideoHotPageState extends State<VideoHotPage>
  ...
  List<String> mBannerAdList = [
    "https://pic.ibaotu.com/01/37/36/29V888piCcP7.jpg-0.jpg!cg845",
    "https://pic.ibaotu.com/01/86/46/888piC4K888piCmJT.jpg!wac",
    "https://img95.699pic.com/photo/40194/0467.jpg_wh300.jpg"
  ];
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: HrlSliverList<VideoModel>(
          headView: mHead(),
  ...
  Future<List<VideoModel>> getListData(pageNum) async {
    ...
    Map<String, dynamic> json =
        await DioManager.instance.get(ServiceUrl.getVideoHotList, params);
