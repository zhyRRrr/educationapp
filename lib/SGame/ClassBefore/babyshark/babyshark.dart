...
class BabyShark extends StatefulWidget {
  @override
  _BabySharkState createState() => _BabySharkState();
}

class _BabySharkState extends State<BabyShark> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/video/BabyShark.mp4')
      ..initialize().then((_) {
        setState(() {});
      })
      ..setLooping(false)
