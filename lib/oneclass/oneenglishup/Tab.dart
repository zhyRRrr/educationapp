...
class OneEnglishup extends StatefulWidget {
  @override
  _OneEnglishupState createState() => _OneEnglishupState();
}

class _OneEnglishupState extends State<OneEnglishup> {
  ...
  Future<void> _loadLastLearned() async {
    ...
    setState(() {
      _lastLearn = prefs.getString('video5_last_learned_title') ?? '';
      _lastLearnedIndex = prefs.getInt('video5_last_learned_index') ?? -1;
