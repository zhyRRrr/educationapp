...
class pingfong extends StatefulWidget {
  @override
  _pingfongState createState() => _pingfongState();
}

class _pingfongState extends State<pingfong> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/video/pinkfong.mp4')
      ..initialize().then((_) {
        setState(() {});
      })
      ..setLooping(false)
