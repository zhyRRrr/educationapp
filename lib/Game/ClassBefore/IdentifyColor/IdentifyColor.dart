...
class IdentifyColor extends StatefulWidget {
  @override
  _IdentifyColorState createState() => _IdentifyColorState();
}

class _IdentifyColorState extends State<IdentifyColor> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/video/color.mp4')
      ..initialize().then((_) {
        setState(() {});
      })
      ..setLooping(false)
