...
void main() {
  runApp(Threeclassmath());
}

class Threeclassmath extends StatefulWidget {
  @override
  _ThreeclassmathState createState() => _ThreeclassmathState();
}

class _ThreeclassmathState extends State<Threeclassmath> {
  ...
  Future<void> _loadLastLearned() async {
    ...
    setState(() {
      _lastLearn = prefs.getString('video11_last_learned_title') ?? '';
      _lastLearnedIndex = prefs.getInt('video11_last_learned_index') ?? -1;
  ...
  void _updateLastLearned(String title, int index) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('video11_last_learned_title', title);
    await prefs.setInt('video11_last_learned_index', index);
  }
