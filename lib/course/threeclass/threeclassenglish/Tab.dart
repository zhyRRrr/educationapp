...
void main() {
  runApp(Threeclassenglish());
}

class Threeclassenglish extends StatefulWidget {
  @override
  _ThreeclassenglishState createState() => _ThreeclassenglishState();
}

class _ThreeclassenglishState extends State<Threeclassenglish> {
  ...
  Future<void> _loadLastLearned() async {
    ...
    setState(() {
      _lastLearn = prefs.getString('video12_last_learned_title') ?? '';
      _lastLearnedIndex = prefs.getInt('video12_last_learned_index') ?? -1;
  ...
  void _updateLastLearned(String title, int index) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('video12_last_learned_title', title);
    await prefs.setInt('video12_last_learned_index', index);
  }
