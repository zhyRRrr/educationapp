import 'package:education_app/course/oneclass/mathxiyoujiclass/HomeWork.dart';
...
class _Video1State extends State<Video1> {
  ...
  void _updateLastLearned(String title, int index) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('video1_last_learned_title', title);
    await prefs.setInt('video1_last_learned_index', index);
  }
