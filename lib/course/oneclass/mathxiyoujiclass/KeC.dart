...
class _KeCState extends State<KeC> {
  ...
  final Map<String, String> _videoPaths = {
    '西游记狂欢会': 'assets/xiyouji/xiyouji1.mp4',
    '锄地分数问题': 'assets/xiyouji/xiyouji2.mp4',
    '平分糖果，数学探讨': 'assets/xiyouji/xiyouji3.mp4',
    '平分蟠桃问题': 'assets/xiyouji/xiyouji4.mp4',
    '运输书本的数学问题': 'assets/xiyouji/xiyouji1.mp4',
    '时分秒的互化': 'assets/xiyouji/xiyouji3.mp4',
    '乘除法的综合运用': 'assets/xiyouji/xiyouji4.mp4',
    '数学之神—高斯的故事': 'assets/xiyouji/xiyouji3.mp4',
    '日历中的规律': 'assets/xiyouji/xiyouji1.mp4',
    '平分正方形': 'assets/xiyouji/xiyouji2.mp4',
    '多位数乘一位数的数乘计算': 'assets/xiyouji/xiyouji1.mp4',
    '迷途导航：计算时的常见问题和心态调整': 'assets/xiyouji/xiyouji4.mp4',
  };
  ...
  Future<void> _initializeVideoPlayer(String videoPath) async {
    // 使用 networkUrl 初始化 VideoPlayerController
    _videoPlayerController = VideoPlayerController.asset(
      videoPath, // 使用 Uri.parse 转换
    );
