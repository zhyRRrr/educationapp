...
void main() {
  runApp(OneMathclassdown());
}

class OneMathclassdown extends StatefulWidget {
  @override
  _OneMathclassdownState createState() => _OneMathclassdownState();
}

class _OneMathclassdownState extends State<OneMathclassdown> {
  ...
  Future<void> _loadLastLearned() async {
    ...
    setState(() {
      _lastLearn = prefs.getString('video2_last_learned_title') ?? '';
      _lastLearnedIndex = prefs.getInt('video2_last_learned_index') ?? -1;
  ...
  void _updateLastLearned(String title, int index) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('video2_last_learned_title', title);
    await prefs.setInt('video2_last_learned_index', index);
  }
