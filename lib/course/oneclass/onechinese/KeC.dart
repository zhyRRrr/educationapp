...
class _KeCState extends State<KeC> {
  ...
  final Map<String, String> _videoPaths = {
    ...
    '语文动画课堂4': 'assets/video/twochinese/chinese3.mp4',
    '语文动画课堂5': 'assets/video/twochinese/chinese1.mp4',
    '语文动画课堂6': 'assets/video/twochinese/chinese2.mp4',
    '语文动画课堂7': 'assets/video/twochinese/chinese1.mp4',
    '语文动画课堂8': 'assets/video/twochinese/chinese2.mp4',
    '语文动画课堂9': 'assets/video/twochinese/chinese3.mp4',
    '语文动画课堂10': 'assets/video/twochinese/chinese2.mp4',
    '语文动画课堂11': 'assets/video/twochinese/chinese1.mp4',
    '语文动画课堂12': 'assets/video/twochinese/chinese3.mp4',
  };
  ...
  Future<void> _initializeVideoPlayer(String videoPath) async {
    try {
      ...
      setState(() {});
      if (videoPath == _videoPaths['语文动画课堂1']) {
