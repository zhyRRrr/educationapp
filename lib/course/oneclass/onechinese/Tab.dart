...
void main() {
  runApp(Oneclasschinese());
}

class Oneclasschinese extends StatefulWidget {
  @override
  _OneclasschineseState createState() => _OneclasschineseState();
}

class _OneclasschineseState extends State<Oneclasschinese> {
  ...
  Future<void> _loadLastLearned() async {
    ...
    setState(() {
      _lastLearn = prefs.getString('video18_last_learned_title') ?? '';
      _lastLearnedIndex = prefs.getInt('video18_last_learned_index') ?? -1;
  ...
  void _updateLastLearned(String title, int index) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('video18_last_learned_title', title);
    await prefs.setInt('video18_last_learned_index', index);
  }
