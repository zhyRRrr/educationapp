...
void main() {
  runApp(OneMathclassup());
}

class OneMathclassup extends StatefulWidget {
  @override
  _OneMathclassupState createState() => _OneMathclassupState();
}

class _OneMathclassupState extends State<OneMathclassup> {
  ...
  Future<void> _loadLastLearned() async {
    ...
    setState(() {
      _lastLearned = prefs.getString('video3_last_learned_title') ?? '';
      _lastLearnedIndex = prefs.getInt('video3_last_learned_index') ?? -1;
  ...
  void _updateLastLearned(String title, int index) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('video3_last_learned_title', title);
    await prefs.setInt('video3_last_learned_index', index);
  }
