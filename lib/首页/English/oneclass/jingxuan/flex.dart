...
class Oneflex extends StatefulWidget {
  @override
  _flexState createState() => _flexState();
}

class _flexState extends State<Oneflex> {
  ...
  final List<Widget> targetPages = [
    ...
    OneEnglishup(), // 对应第二个图像的页面english
    OneMathclassup(), // 对应第三个图像的页面
  ];
                  ...
                  child: Column(
                    children: [
                      GestureDetector(
                        ...
                        child:
                            _buildCard("来进入", "数字动画课堂", "assets/images/举手.png"),
                      ),
                      SizedBox(height: 16),
