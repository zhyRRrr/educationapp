...
class ThreeClassflex extends StatefulWidget {
  @override
  _flexState createState() => _flexState();
}

class _flexState extends State<ThreeClassflex> {
  final List<String> imgList = [
    "assets/images/3.0x/pk.jpg",
    "assets/images/3.0x/migong.jpg",
    "assets/images/3.0x/woshishui.jpg",
  ];
                  ...
                  child: Column(
                    children: [
                      GestureDetector(
                        ...
                        child:
                            _buildCard("来进入", "宝可梦的世界", "assets/images/举手.png"),
                      ),
                      SizedBox(height: 16),
