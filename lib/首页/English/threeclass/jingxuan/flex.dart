...
class Threeflex extends StatefulWidget {
  @override
  _flexState createState() => _flexState();
}

class _flexState extends State<Threeflex> {
                  ...
                  child: Column(
                    children: [
                      GestureDetector(
                        ...
                        child: _buildCard(
                            "欢迎来到", "动画课堂的时间", "assets/images/举手.png"),
                      ),
                      SizedBox(height: 16),
                      _buildCard("进入数字课堂", "课堂互动精选推荐", "assets/images/举手.png"),
                    ],
                  ),
                ),
              ],
