import 'package:education_app/Book/OneClass/OneClassMath.dart';
...
import 'package:education_app/oneclass/onemathclassup/Tab.dart';
import 'package:flutter/material.dart';
import 'package:carousel_slider/carousel_slider.dart';

class TwoClassMathflex extends StatefulWidget {
  @override
  _flexState createState() => _flexState();
}

class _flexState extends State<TwoClassMathflex> {
  final List<String> imgList = [
    "assets/images/course/chinese/chinese8.jpg",
    "assets/images/course/chinese/chinese10.jpg",
    "assets/images/course/chinese/chinese13.jpg",
  ];

  final List<Widget> targetPages = [
    OneMathclassup(), // 对应第一个图像的页面
    TwoMathclass(), // 对应第二个图像的页面
                  ...
                  child: Column(
                    children: [
                      GestureDetector(
                        ...
                        child:
                            _buildCard("来进入", "数字课堂", "assets/images/举手.png"),
                      ),
                      SizedBox(height: 16),
